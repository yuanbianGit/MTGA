...
class MGN(nn.Module):
    def __init__(self,num_classes):
        ...
        reduction = nn.Sequential(nn.Conv2d(2048, feats_num, 1, bias=False), nn.BatchNorm2d(feats_num), nn.ReLU())
        ...
        self.fc_id_2048_0 = nn.Linear(feats_num, num_classes)
        self.fc_id_2048_1 = nn.Linear(feats_num, num_classes)
        self.fc_id_2048_2 = nn.Linear(feats_num, num_classes)

        self.fc_id_256_1_0 = nn.Linear(feats_num, num_classes)
        self.fc_id_256_1_1 = nn.Linear(feats_num, num_classes)
        self.fc_id_256_2_0 = nn.Linear(feats_num, num_classes)
        self.fc_id_256_2_1 = nn.Linear(feats_num, num_classes)
        self.fc_id_256_2_2 = nn.Linear(feats_num, num_classes)
    ...
    def forward(self, x, is_training=False):
        ...
        # print(l2_p3.size())
        # print(torch.mean(torch.stack([l0_p2,l1_p2,l0_p3,l1_p3,l2_p3]),dim=0).size())
        predict = torch.cat([fg_p1, fg_p2, fg_p3, f0_p2, f1_p2, f0_p3, f1_p3, f2_p3], dim=1)
        # if istraning:
        #     return predict, fg_p1, fg_p2, fg_p3, l_p1, l_p2, l_p3, l0_p2, l1_p2, l0_p3, l1_p3, l2_p3
        if is_training:
            return [torch.mean(torch.stack([l0_p2,l1_p2,l0_p3,l1_p3,l2_p3]),dim=0)]
